...
Lists the people who can access the bucket: the workspace owner plus every accepted team member granted access, with each member's permissions. Use this for "who has access", "how many users/people are in this bucket", or "list the team members". Returns names and permissions only — never email addresses.
...
{
  "bucket_id": "b_xyz789",
  "bucket_name": "Company Research",
  "owner": { "name": "Asad Jutt", "is_owner": true },
  "members": [
    {
...
| `list_members` | List who can access the bucket — owner + team members and their permissions (names only) |
