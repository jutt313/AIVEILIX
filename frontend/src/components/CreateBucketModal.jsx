...
export default function CreateBucketModal({ isOpen, onClose, onCreate }) {
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-sm ${isDark ? 'bg-black/50' : 'bg-white/50'
      }`}>
      <div className={`w-full max-w-4xl rounded-3xl backdrop-blur-xl border p-8 ${isDark
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className={`border-2 border-dashed rounded-xl p-8 text-center transition-colors min-h-[300px] flex flex-col justify-center ${isDark
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="flex items-center gap-2 my-2">
                    <div className={`flex-1 h-px ${isDark ? 'bg-white/10' : 'bg-[#1FE0A5]/20'
                      }`}></div>
                    <span className={`text-xs ${isDark ? 'text-dark-text/40' : 'text-[#062A33]/40'
                      }`}>OR</span>
                    <div className={`flex-1 h-px ${isDark ? 'bg-white/10' : 'bg-[#1FE0A5]/20'
                      }`}></div>
                  </div>
