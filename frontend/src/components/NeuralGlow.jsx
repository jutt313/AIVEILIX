...
const NeuralGlow = () => {
  ...
  const fragmentShaderSource = `
    ...
    void main() {
        ...
        // AIveilix Teal color palette
        vec3 teal = vec3(0.176, 1.0, 0.718); // #2DFFB7
        vec3 darkTeal = vec3(0.043, 0.235, 0.286); // #0B3C49

        color = mix(darkTeal, teal, sin(3.0 * u_scroll_progress + 1.5) * 0.5 + 0.5);
        color = color * noise;
  ...
  return (
    <canvas
      ref={canvasRef}
      className="absolute top-0 left-0 w-full pointer-events-none opacity-95"
      style={{
